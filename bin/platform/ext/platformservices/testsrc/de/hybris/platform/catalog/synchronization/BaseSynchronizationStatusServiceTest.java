...
public class BaseSynchronizationStatusServiceTest extends ServicelayerBaseTest
{
	                                   ...
	                                   final String qualifier)
	{
		...
		try
		{
			itemCounterpart = (T) catalogTypeService.getCatalogVersionAwareModel(targetCatalogVersion, itemModel.getItemtype(),
					Maps.newHashMap(qualifier, itemModel.getProperty(
							qualifier)));
		}
	...
	protected void assertSyncInfoEquals(final SyncItemInfo actual, final SyncItemStatus expectedStatus,
	                                    final PK expectedSyncJobPk,
	                                    final PK expectedPk)
	{
	...
	protected SyncItemJobModel createSyncJob(final String code, final CatalogVersionModel source,
