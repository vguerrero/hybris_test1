...
public class CartServiceTest extends ServicelayerTransactionalTest
{
	...
	public void testGetSessionCartWhenJaloSessionUpdates()
	{
		...
		assertEquals("CartService got different session cart than JaloSession", jaloCartAutoCreated,
				modelService.getSource(cart));
	...
	public void testChangeSomeQuantitiesInCartOldStyle() throws InvalidCartException
	{
		...
		cartService.updateQuantities(cart,
				newQuantities);// should trigger save of cart as well as result of prepare interceptors!!!
