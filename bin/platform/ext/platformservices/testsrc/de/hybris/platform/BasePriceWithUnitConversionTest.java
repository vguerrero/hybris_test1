...
public class BasePriceWithUnitConversionTest extends ServicelayerTransactionalTest
{
	...
	private OrderEntryModel createOrderEntry(final OrderModel order, final ProductModel product, final Long quantity,
	...
	private PriceRowModel createPriceRow(final CurrencyModel currency, final UnitModel unit, final ProductModel product,
	                                     final double price)
	{
