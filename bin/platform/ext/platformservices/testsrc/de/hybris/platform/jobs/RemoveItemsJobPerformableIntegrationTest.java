...
public class RemoveItemsJobPerformableIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void setUp()
	{
		...
		try
		{
			inputStream = new DataInputStream(new ItemListInputStream(allModelsList));
	...
	public void testRemoveAllItemsWithoutSufficientRights()
	{
		...
		Assert.assertEquals("Should  be there all refused disposals ", allModelsList.size(),
	...
	private class ItemListInputStream extends InputStream
	{
		 ...
		 * Constructor.
		 *
		 * @param itemList A list of items containing PK Strings or Item objects.
		 */
