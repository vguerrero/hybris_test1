...
public class CatalogSystemSetupTest extends ServicelayerTest
{
	...
	public void patchOldSyncTimestamps()
	{
		...
		final String modTsAd = typeService.getAttributeDescriptor(productType, ItemSyncTimestamp.MODIFIED_TIME)
		                                  .getDatabaseColumn();
		...
		final int prodUpdated = jdbcTemplate.update(
				"UPDATE " + productType.getTable() + " SET " + modTsAd + " = NULL WHERE PK = ?",
