...
public class ChildBeanPostProcessorStrategy
{
	 ...
	 * beans.
	 *
	 * @param beanClass      class of beans to process
	 * @param targetProvider starting bean defining bean hierarchy
	 * @param operation      operation executed on selected beans
	 */
