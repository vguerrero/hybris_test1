...
public class CloneAbstractOrderStrategy
{
	 ...
	 * @param abstractOrderClassResult super class of clone (usually OrderModel or CartModel)
	 */
	public <E extends AbstractOrderEntryModel, T extends AbstractOrderModel> T clone(final ComposedTypeModel _orderType,
	                                                                                 final ComposedTypeModel _entryType,
	                                                                                 final AbstractOrderModel original,
	                                                                                 final String code,
	                                                                                 final Class<T> abstractOrderClassResult,
	                                                                                 final Class<E> abstractOrderEntryClassResult)
	{
	 ...
	 *
	 * @param _entryType desited {@link ComposedTypeModel} of the cloned cart entries .
