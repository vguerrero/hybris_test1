...
public interface QuoteService
{
	 ...
	 * @throws IllegalArgumentException in case code is null
	 * @throws ModelNotFoundException   in case there is no latest snapshot for the given code
	 */
	 ...
	 *
	 * @param code    the code to query for
	 * @param version the version to query for
	 * @return unique quote for the given code and version
	 * @throws IllegalArgumentException in case one of the parameters is null
	 * @throws ModelNotFoundException   in case there is no unique quote for the given code and version
	 */
	 ...
	 *
	 * @param cart the cart based on which the new quote will be created
	 * @return the new quote
	 * @throws IllegalArgumentException in case cart is null
	 */
	 ...
	 *
	 * @param quote      quote to create the snapshot from
	 * @param quoteState desired state of the quote
