...
public interface EntryGroupService
{
	 ...
	 *
	 * @param entryGroup root {@link EntryGroup}
	 ...
	 *
	 * @param groupNumber number of the group to search for
	 * @param order       order containing entry group trees
	 * @return {@link EntryGroup} with given groupNumber from the order
	 * @throws IllegalArgumentException if no group with given groupNumber in the order
	 */
	@Nonnull
	 ...
	 *
	 * @param order       order to take trees from
	 * @param groupNumber number of group to search for
	 ...
	 * @throws IllegalArgumentException if group is not found in the cart
	 */
	 ...
	 */
	EntryGroup getGroupOfType(@Nonnull final AbstractOrderModel order, @Nonnull final Collection<Integer> groupNumbers,
