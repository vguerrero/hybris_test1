...
public class DefaultPDTCriteriaFactory implements PDTCriteriaFactory
{
	...
	@Override
	public TaxValueInfoCriteria taxValueCriteriaFromOrderEntry(final AbstractOrderEntryModel orderEntry)
	...
	public TaxValueInfoCriteria taxInfoCriteriaFromPriceCriteria(final BaseCriteria baseCriteria) throws CalculationException
	{
		return DefaultTaxValueInfoCriteria.buildForInfo()//
		                                  ...
		                                  .withUserTaxGroup(pdtEnumGroupsHelper.getUTG(userService.getCurrentUser()))
			...
			throws CalculationException
	{
		...
		return DefaultDiscountValueInfoCriteria.buildForInfo() //
		                                       ...
		                                       .withCurrency(
				                                       sessionService.getAttribute(I18NConstants.CURRENCY_SESSION_ATTR_KEY)) //
		                                       .withDate(baseCriteria.getDate()) //
		                                       .build();
	}

	@Override
	public PriceValueInfoCriteria priceValueCriteriaFromOrderEntry(final AbstractOrderEntryModel orderEntry)
			throws CalculationException
	{
		final AbstractOrderModel order = orderEntry.getOrder();
