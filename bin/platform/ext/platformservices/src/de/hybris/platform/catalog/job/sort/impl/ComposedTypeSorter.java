...
public class ComposedTypeSorter implements Sorter<ComposedTypeModel>
{
	...
	/**
	 * @param originalComposedTypeSet unsorted set of composed types from the catalog manager
	...
	public List<ComposedTypeModel> sort(final Collection<ComposedTypeModel> originalComposedTypeSet)
	{
		...
		final Set<ComposedTypeModel> origSet = new HashSet<ComposedTypeModel>(
				originalComposedTypeSet); //clone the set, we remove elements from it
