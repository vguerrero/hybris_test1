...
public interface LoadStoreFeaturesStrategy
{
	 ...
	 *
	 * @param product the product for which list of <code>Feature</code>s will be loaded
	 * @return the result list of <code>Feature</code> objects
	 * @throws IllegalArgumentException thrown when <code>product</code> is not persisted
	 */
	 ...
	 * @param features the list of features to store
	 * @throws IllegalArgumentException thrown when <code>product</code> is not persisted
	 */
	 ...
	 * <code>true</code> all existing features which are not on the <code>features</code> list will be removed.
	 *
	 * @param allAssignments all assignment to take into consideration for replacement
	 * @param product        the product
	 * @param features       the list of features to store
	 * @throws IllegalArgumentException thrown when <code>product</code> is not persisted
	 */
