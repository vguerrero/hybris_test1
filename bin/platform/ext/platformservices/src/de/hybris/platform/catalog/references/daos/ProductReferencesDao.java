...
public interface ProductReferencesDao
{
	 ...
	 *
	 * @param product product for which we are searching references
	 */
	 ...
	 *
	 * @param qualifier     reference's {@link ProductReferenceModel#QUALIFIER}. If <code>null</code>, qualifier will be ignored as
	 *                      a search criterion
	 * @param sourceProduct references's {@link ProductReferenceModel#SOURCE}. If <code>null</code>, sourceProduct will be ignored
	 *                      as a search criterion
	 * @param targetProduct references's {@link ProductReferenceModel#TARGET}. If <code>null</code>, targetProduct will be ignored
	 *                      as a search criterion
	 * @param type          references's {@link ProductReferenceModel#REFERENCETYPE}. If <code>null</code>, type will be ignored as
	 *                      a search criterion
	 * @param active        references's {@link ProductReferenceModel#ACTIVE} flag. If <code>null</code>, active will be ignored as
	 *                      a search criterion
	 * @return List of {@link ProductReferenceModel}s or empty list if no matching product reference was found.
	 * @throws IllegalArgumentException if qualifier <b>AND</b> source <b>AND</b> target <b>AND</b> type arguments are
