...
public class DefaultEntryGroupService implements EntryGroupService
{
	...
	@Override
	public EntryGroup getGroupOfType(@Nonnull final AbstractOrderModel order, @Nonnull final Collection<Integer> groupNumbers,
	                                 @Nonnull final GroupType type)
	{
		...
		if (groups.size() > 1)
		{
			throw new AmbiguousIdentifierException(
					"More than one entry group of type " + type + " found in order " + order.getCode()
