...
public interface ItemSyncTimestampDao
{
	 ...
	 *
	 * @param item  {@link ItemModel} for which we are searching sync timestamps
	 * @param limit limit count of result (-1 : no limit)
	 */
	 ...
	 *
	 * @param catalogVersion {@link CatalogVersionModel} for which we are searching sync timestamps
	 * @param limit          limit count of result (-1 : no limit)
	 */
