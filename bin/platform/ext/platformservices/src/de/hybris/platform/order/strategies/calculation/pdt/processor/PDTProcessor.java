...
public interface PDTProcessor
{
	 ...
	 * processing<br>
	 *
	 * @param context contains criteria and values/information to process
	 * @param chain   provides access to the next processor in the chain for this processor to pass the context to for further
	 *                processing
	 */
