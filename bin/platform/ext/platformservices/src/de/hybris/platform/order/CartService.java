...
public interface CartService extends AbstractOrderService<CartModel, CartEntryModel>
{
	 ...
	 *
	 * @param cart       the cart where the quantities are updated
	 * @param quantities the new quantity list for each cart entry
	 ...
	 *
	 * @param cart       the cart to update cart entry quantities at
	 * @param quantities the entry specific quantities as map of { entry number -> quantity }
	 */
	 ...
	 *
	 * @param sourceCart the cart providing the entries to copy
	 * @param targetCart the target cart to create new entries for
	 * @throws IllegalArgumentException if targetCart is null.
	 */
	 ...
	 *
	 * @param user new session cart user
	 ...
	 * created.
	 *
	 * @param currency new session cart currency
	 */
	 ...
	 *
	 * @param quote the quote model
	 * @return the new cart model
	 * @throws IllegalArgumentException when quote is null
	 */
