...
public class CalculationTest extends HybrisJUnit4TransactionalTest
{
	...
	{
		// check property name
		assertTrue("property name was not 'weight' but " + deliveryMode.getPropertyName(),
				deliveryMode.getPropertyName().equals("weight"));
		// check zones
		...
		assertTrue(" expected z2 -> cu2 -> { 0 => 50.0 10 => 20.00 } but got " + map,
				map != null && map.containsKey(new Double(0))
