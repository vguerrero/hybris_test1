...
public class ProcessActionWithParamTest extends ServicelayerBaseTest
{
	...
	public void setUp()
	{
		...
		this.processDefinitionFactory
				.add(new InputSource(new StringReader(ProcessDefinitionBuilder.builder(PROCESS_DEFINITION_NAME_OK, START_NODE)
				                                                              ...
				                                                              .addEndNode(SUCCESS, ProcessState.SUCCEEDED,
						                                                              END_MSG)
		...
		this.processDefinitionFactory.add(new InputSource(new StringReader(ProcessDefinitionBuilder
				.builder(PROCESS_DEFINITION_NAME_SCRIPT,
						START_NODE)
		...
		this.processDefinitionFactory.add(new InputSource(new StringReader(ProcessDefinitionBuilder
				.builder(
						PROCESS_DEFINITION_NAME_ACTION_SCRIPT_COMBO,
						START_NODE)
				.withActionNode(START_NODE, ACTION_BEAN)
				.withParameter(PARAMETER_NAME, PARAM_OK)
	...
	{
		assertThat(
				processDefinitionFactory.getProcessDefinition(new ProcessDefinitionId(PROCESS_DEFINITION_NAME_OK))).isNotNull();
		...
		assertThat(testParameterAction.getActionDefinitionContext().getParameter(PARAMETER_NAME)).isEqualTo(
				Optional.of(PARAM_OK));
