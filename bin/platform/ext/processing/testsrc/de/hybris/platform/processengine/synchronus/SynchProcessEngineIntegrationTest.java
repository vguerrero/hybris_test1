...
public class SynchProcessEngineIntegrationTest extends AbstractProcessEngineIntegrationTest
{
	...
	private void initTracks()
	{
		...
		tracker.addSynchroGroup("GR_2_SYNCH", "thirdStep", "fourthStep", "fifthStep");
	...
	private class Context
	{
		...
		{
			tracker.trackThreadAndTransactionForAction(action, Thread.currentThread().getName(),
					Transaction.current().getObjectID());
		}
	}
}
