...
public class DefaultCronJobHistoryDaoTest extends AbstractCronJobHistoryTest
{
	...
	public void setUp()
	{
		...
		cronJobHistoryModelList
				.add(createEntity(jobOne, adminUser, baseStartDate, baseFinishDate, CronJobResult.SUCCESS,
	...
	public void testFindAllCronJobHistoryByCronJobResult()
	{
		...
		assertThat(result).contains(cronJobHistoryModelList.get(0), cronJobHistoryModelList.get(1),
	...
	public void testFindAllCronJobHistoryByJobItemType()
	{
		...
		final CronJobHistoryModel cronJobHistoryModel1 = createEntity(catalogSyncItemJob, adminUser, baseStartDate,
				baseFinishDate,
				null, null);
	...
	public void testFindAllCronJobHistoryByMultipleIncludesForDifferentCriteria()
	{
		...
		final List<CronJobHistoryModel> mergedIncludeResult = cronJobHistoryDao.findCronJobHistoryBy(
				Sets.newHashSet(mergedInclude),
