...
import de.hybris.platform.task.impl.TasksProvider.VersionPK;
...
public class TaskEngineItemsBufferTest
{
	...
	private BufferedTasksProvider.ItemsBuffer itemsBuffer;

	@Before
	public void setUp()
	{
		itemsBuffer = new BufferedTasksProvider.ItemsBuffer();
	}
	...
	public void shouldProvideRequestedNumberOfTasksWhenMoreIsAvailable()
	{
		...
		assertThat(nextPart).isNotNull().hasSize(10).doesNotContainNull().containsExactly( //
				versionPK(1), versionPK(2),
				versionPK(3), versionPK(4),
				versionPK(5), //
				versionPK(6), versionPK(7),
				versionPK(8), versionPK(9),
				versionPK(10));
	...
	public void shouldProvideAvailableNumberOfTasksWhenLessThanRequestedIsAvailable()
	{
		...
		assertThat(nextPart).isNotNull().hasSize(15).doesNotContainNull().containsExactly( //
				...
				versionPK(8), versionPK(9),
				versionPK(10), //
				versionPK(11), versionPK(12),
				versionPK(13), versionPK(14),
				versionPK(15));
	...
	public void shouldntBeReadedFullyByConsecutiveReads()
	{
		...
		List<VersionPK> nextPart = itemsBuffer.getNextItems(3);
