...
<div id="tabsNoSidebar">
    ...
    <div id="tabs-2">
        ...
        <form:form method="post" action="${fileImportUrl}?${_csrf.parameterName}=${_csrf.token}" modelAttribute="impexImportFile" enctype="multipart/form-data">
            <fieldset>
                <legend>
...
<div class="span-6 last" id="sidebar">
    <div class="prepend-top" id="recent-reviews">
        ...
        <div class="box">
            <div class="quiet">
                <ul>
                    <li><a href="${wikiImpex}" target="_blank" class="quiet">ImpEx</a></li>
                </ul>
            </div>
        </div>
    </div>
