		...
		<div class="prepend-top" id="recent-reviews">
			...
			<div class="box">
				<div class="quiet">
					...
					<ul>
						 <li> <a href="${wikiSpringInHybrisCommerceSuite}" target="_blank" class="quiet">Spring Framework in SAP Commerce</a> </li>
                        <li> <a href="${wikiMultiTenantSystem}" target="_blank" class="quiet">Multi-Tenant Systems</a> </li>
					</ul>
				</div>
			</div>		
		</div>
