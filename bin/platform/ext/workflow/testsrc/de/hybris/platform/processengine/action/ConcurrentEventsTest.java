...
public class ConcurrentEventsTest extends ServicelayerBaseTest
{
	...
	public void tearDown()
	{
		...
		Registry.getCurrentTenantNoFallback()
		        .getConfig()
		        .setParameter(TaskConstants.Params.POLLING_INTERVAL, taskEngineIntervalToRestore);
	}

	// HORST-825 (add @Test and change to public)
	private void shouldFinishBattleshipsGameWithoutErrors() throws InterruptedException, IOException
	{
