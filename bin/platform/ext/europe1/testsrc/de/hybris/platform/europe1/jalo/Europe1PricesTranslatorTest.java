...
public class Europe1PricesTranslatorTest extends HybrisJUnit4TransactionalTest
{
	...
	public void testExport() throws Exception
	{
		...
		@SuppressWarnings("deprecation") final EnumerationValue channelEv = EnumerationManager.getInstance()
		                                                                                      .getEnumerationValue(
				                                                                                      "PriceRowChannel",
	...
	public void testOverallImport()
	{
		...
		final String data = "#% impex.setLocale( Locale.GERMANY );\n"
				...
				+ ";" + testProductChannel.getCode(
				ctx) + ";;dummy 27 pieces = 0,99 " + EUR + " N [17.10.2005,28.05.2006] desktop\n";//channel provided
	...
	public void testReImport() throws Exception
	{
		...
		Collection<PriceRow> rows = (Collection<PriceRow>) trans.importValue(
				trans.exportValue(epf.getEurope1Prices(testProduct1)),
				testProduct1);
		assertNotNull(rows);
		assertEquals(1, rows.size());
