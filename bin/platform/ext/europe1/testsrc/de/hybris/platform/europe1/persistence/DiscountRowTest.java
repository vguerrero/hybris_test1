...
public class DiscountRowTest extends HybrisJUnit4Test
{
	...
	public void setUp() throws Exception
	{
		...
		assertNotNull(
				userGroup = EnumerationManager.getInstance().createEnumerationValue(Europe1Constants.TYPES.DISCOUNT_USER_GROUP,
						"test"));

		assertNotNull(
				discountRow = europe1.createDiscountRow(product, null, null, userGroup, currency, new Double(0.0), null, dis));
	}
