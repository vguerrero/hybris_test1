...
public class VariantsTest extends ServicelayerTransactionalTest
{
	...
	private EnumerationValue s;
	@SuppressWarnings("unused")
	private EnumerationValue m;
	@SuppressWarnings("unused")
	private EnumerationValue l;
	@SuppressWarnings("unused")
	private EnumerationValue xl;
	...
	public void testVariants() throws Exception
	{
		...
		/* final Collection baseProducts = */
		manager.getAllBaseProducts(jaloSession.getSessionContext());
	...
	public void testAttributeAccessorClash() throws JaloInvalidParameterException, JaloBusinessException
	{
		...
		assertNotNull(ad1 = shoeType.createVariantAttributeDescriptor("foo",
				(AtomicType) typeManager.getAtomicTypesForJavaClass(
						Double.class).iterator().next(),
