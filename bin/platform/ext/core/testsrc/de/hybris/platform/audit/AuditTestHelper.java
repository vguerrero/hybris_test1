...
public class AuditTestHelper
{
	...
	public AuditReportConfig createTestConfigForIntegrationTest()
	{
		...
		final Type user = Type.builder().withCode(UserModel._TYPECODE) //
		                      ...
		                      .withReferenceAttributes( //
				                      ReferenceAttribute.builder()
				                                        ...
				                                        .build(), //
				                      ReferenceAttribute.builder()
				                                        .withQualifier("defaultShipmentAddress")
				                                        .withType(address)
				                                        .withResolvesBy( //
						                                        ResolvesBy.builder()
						                                                  .withResolverBeanId(
		...
		final AuditReportConfig reportConfig = AuditReportConfig.builder() //
		                                                        ...
		                                                        .withTypes(user, address, title, media, userGroup) //
		                                                        .build();
	...
	{
		return Registry.getApplicationContext().getBean("auditConfigService", AuditConfigService.class);
	}
}
