...
public class InvalidationTest extends HybrisJUnit4TransactionalTest
{
	...
	@Test
	public void testSuperTopicNotification()
	{
		final Object[] firstkey = new Object[]
				{ "first", "key" };
		listenerMock.keyInvalidated(firstkey, AbstractCacheUnit.INVALIDATIONTYPE_MODIFIED, Registry.getCurrentTenant().getCache(),
	...
	public void testNotification()
	{
		...
		listenerMock.keyInvalidated(firstkey, AbstractCacheUnit.INVALIDATIONTYPE_MODIFIED, Registry.getCurrentTenant().getCache(),
				null);
		expectLastCall();
		listenerMock.keyInvalidated(secondkey, AbstractCacheUnit.INVALIDATIONTYPE_MODIFIED,
	...
	public void testMulticast()
	{
		final Object[] key = new Object[]
				{ "some", "key" };
		listenerMock.keyInvalidated(key, AbstractCacheUnit.INVALIDATIONTYPE_MODIFIED, Registry.getCurrentTenant().getCache(),
				null);
		expectLastCall();
		//control.activate();
		replay(listenerMock);
