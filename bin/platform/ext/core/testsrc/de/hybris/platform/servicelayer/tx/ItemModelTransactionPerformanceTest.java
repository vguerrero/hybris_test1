...
public class ItemModelTransactionPerformanceTest extends ServicelayerBaseTest
{
	...
	private void testBusyWaitingUpdateReload(final int durationSeconds)
	{
		...
		final de.hybris.platform.test.RunnerCreator<BusyWaitingUpdateReloadRunner> creator = new de.hybris.platform.test.RunnerCreator<BusyWaitingUpdateReloadRunner>()
		{
			@Override
		...
		final TestThreadsHolder<BusyWaitingUpdateReloadRunner> threads = new TestThreadsHolder<>(2, creator);
	...
	protected String dumpMediaMimeInfo(final MediaModel media)
	{
		...
		final boolean txCacheIsolationEnabled = true;
