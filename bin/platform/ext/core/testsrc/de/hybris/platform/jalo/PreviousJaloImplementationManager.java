...
abstract class PreviousJaloImplementationManager
{
	...
	private static String getCachedClassName(final ItemImpl impl)
	{
		final PK typeKey = impl.getTypeKey(); // use cached type key
	...
	static final BridgeAbstraction createJaloObject(final Tenant tenant, final ItemImpl impl)
	{
		...
		else
		{
			...
			catch (final Exception e)
			{
				...
				final String pk = impl instanceof Item.ItemImpl ? impl.getPK().toString() : "n/a";
