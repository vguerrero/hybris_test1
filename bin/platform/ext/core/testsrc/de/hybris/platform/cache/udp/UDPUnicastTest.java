...
public class UDPUnicastTest extends HybrisJUnit4Test
{
	...
	public void testConfigUpdate()
	{
		...
		params.put(DefaultUnicastBroadcastConfiguration.CFG_SERVERADDRESS, "127.0.0.1");
	...
	public void testClusterOfThree()
	{
		...
		final InetSocketAddress[] allNodes =
				{ InetSocketAddress.createUnresolved("127.0.0.1", defaultCfg.getServerAddress().getPort() + 1),
						InetSocketAddress.createUnresolved("127.0.0.1", defaultCfg.getServerAddress().getPort() + 2),
						InetSocketAddress.createUnresolved("127.0.0.1", defaultCfg.getServerAddress().getPort() + 3) };
