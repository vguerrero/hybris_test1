...
public class CSVUtilsTest
{
	...
	public void testCSVUtils() throws Exception
	{
		...
		assertTrue(CSVUtils.escapeString(testString10, value1, false).equals(
				"abc\\\\def\\\";ab\\\";;\\\"\\\"gh\\\\\\\\\\\"\\\"\\\\"));
		assertTrue(
				CSVUtils.unescapeString(CSVUtils.escapeString(testString10, value1, false), value1, false).equals(testString10));

		assertTrue(CSVUtils.escapeString(testString10, value2, false).equals(
				"abc\\\\def\\\"\\;ab\\\"\\;\\;\\\"\\\"gh\\\\\\\\\\\"\\\"\\\\"));
		assertTrue(
				CSVUtils.unescapeString(CSVUtils.escapeString(testString10, value2, false), value2, false).equals(testString10));

		assertTrue(CSVUtils.escapeString(testString10, value3, false).equals("abc\\\\def\";ab\";;\"\"gh\\\\\\\\\"\"\\\\"));
		assertTrue(
				CSVUtils.unescapeString(CSVUtils.escapeString(testString10, value3, false), value3, false).equals(testString10));
