...
public class ClasspathEfficiencyEvaluatorTest
{
	...
	public void shouldReorderClasspath()
	{
		...
		final ClasspathReorderingResult reorderingResult = classpathEfficiencyEvaluator.reorderClasspath(
				ImmutableList.of("jar1.jar", "jar2.jar"), events, resourceInfoMap);
