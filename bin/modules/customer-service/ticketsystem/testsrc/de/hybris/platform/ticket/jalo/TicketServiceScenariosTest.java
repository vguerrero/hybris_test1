...
public class TicketServiceScenariosTest extends AbstractTicketsystemTest
{
	...
	public void testScenario2()
	{
		...
		final CsTicketModel ticket = ticketService.getTicketForTicketId("test-ticket-6");
	...
	public void testScenario3()
	{
        ...
        ticketParameter.setAssignedGroup(testGroup);
        ticketParameter.setHeadline(headline);
        ticketParameter.setInterventionType(CsInterventionType.EMAIL);
        ticketParameter.setReason( CsEventReason.FIRSTCONTACT);
        ticketParameter.setCreationNotes(note);
	...
	public void testScenario4()
	{
		...
		final CsTicketModel ticket = ticketService.getTicketForTicketId("test-ticket-7");
	...
	public void testScenario5()
	{
        ...
        ticketParameter.setCategory(CsTicketCategory.COMPLAINT);
        ticketParameter.setPriority( CsTicketPriority.HIGH);
        ticketParameter.setAssignedAgent(adminUser);
        ticketParameter.setAssignedGroup(null);
        ticketParameter.setHeadline(headline);
        ticketParameter.setInterventionType(CsInterventionType.CALL);
        ticketParameter.setReason( CsEventReason.COMPLAINT);
        ticketParameter.setCreationNotes(note);
