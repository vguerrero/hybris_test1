...
{
	private static final Logger LOGGER = LoggerFactory.getLogger(RequestBatchEntityBuilder.class);
	...
	protected String deriveIntegrationKey(final ODataContext context)
	{
		...
		{
			LOGGER.error("Failed to extract integration key from request path", e);
		}
		return "";
	}
