...
public class CustomODataExceptionAwareErrorCallbackUnitTest
{
	...
	{
		context.setException(new InternalProcessingException("Duplicate primary key!"));
		context.setContentType("application/json");
	}

	private void givenInvalidDataException()
	{
		context.setException(new InvalidDataException("Key [name of key] is required.", "missing_key", "entityType"));
	}
